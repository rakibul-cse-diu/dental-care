...
const CheckOut = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center my-12'>
            ...
            <form onSubmit={handleConfrim} className='flex flex-col w-3/4 md:w-1/4'>
                ...
                <input className='my-5 px-6 py-1 bg-[#1F2B6C] text-white text-lg font-semibold cursor-pointer' type="submit" value="Confrim" />
            </form>
        </div>
    );
};
